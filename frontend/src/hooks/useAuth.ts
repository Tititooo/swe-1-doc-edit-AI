...
const DEV_EMAIL = import.meta.env.VITE_DEV_BOOTSTRAP_EMAIL || 'atharv.dev@local'
const DEV_PASSWORD = import.meta.env.VITE_DEV_BOOTSTRAP_PASSWORD || 'atharv-preview-pass'
