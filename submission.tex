...
---
graph TB
    user["<<person>><br/><b>Document User</b><br/><small>Creates/edits docs,
    invokes AI, collaborates</small>"]

    admin["<<person>><br/><b>Organization Admin</b><br/><small>Configures roles,
    AI feature toggles, quotas</small>"]

    system["<<system>><br/><b>Collaborative Document Editor</b><br/><small>Real-time
    collaborative editing platform with tracked AI suggestions,
    version history, and role-based sharing</small>"]

    groq["<<external system>><br/><b>Groq LLM API</b><br/><small>Receives prompt,
    returns streamed completion</small>"]

    email["<<external system>><br/><b>Email Service (future)</b><br/><small>Sends sharing
    notifications</small>"]
...
graph TB
    ...
    groq["<<external system>><br/><b>Groq LLM API</b><br/><small>LLM inference,
    streamed completions</small>"]

    subgraph system[" "]
        spa["<<container>><br/><b>React SPA</b><br/><small>React 18, Tiptap 2, Yjs,
        React Query, Zustand<br/>-----<br/>Editor UI, Yjs client CRDT,
        AI suggestion display, auth, sharing, versioning</small>"]
        api["<<container>><br/><b>FastAPI Backend</b><br/><small>Python 3.12, FastAPI,
        SQLAlchemy, Pydantic<br/>-----<br/>Auth, doc CRUD, content projection,
        AI proxy, permissions, admin</small>"]
        collab["<<container>><br/><b>Collaboration Server</b><br/><small>Node.js 20,
        y-websocket<br/>-----<br/>CRDT sync, presence broadcast,
        snapshot persistence</small>"]
        db[("<<database>><br/><b>PostgreSQL</b><br/><small>PostgreSQL 16, Render managed
        <br/>-----<br/>Users, docs, versions, permissions, AI logs</small>")]
...
\begin{verbatim}
---
title: C4 Level 3 - FastAPI Backend Components
---
graph TB
    spa["<<container>><br/><b>React SPA</b><br/><small>Sends HTTP requests,
    receives SSE streams</small>"]

    groq["<<external system>><br/><b>Groq LLM API</b><br/><small>Streams completions</small>"]

    db[("<<database>><br/><b>PostgreSQL</b><br/><small>Persistent storage</small>")]

    subgraph api["FastAPI Backend"]
        app["<<component>><br/><b>FastAPI App</b><br/><small>backend/api/main.py<br/>-----
        <br/>Route registration, CORS, lifespan, exception handling</small>"]
        schemas["<<component>><br/><b>Schema Layer</b><br/><small>backend/api/schemas.py
        <br/>-----<br/>Pydantic request/response contracts</small>"]
        auth["<<component>><br/><b>Auth Module</b><br/><small>backend/api/auth.py<br/>-----
        <br/>Password hashing, JWT access and refresh tokens</small>"]
        runtime["<<component>><br/><b>Runtime Service</b><br/><small>backend/api/runtime.py
        <br/>-----<br/>Login, registration, doc metadata, permissions,
        AI history, quotas, admin</small>"]
        store["<<component>><br/><b>Document Content Store</b><br/><small>backend/api/store.py
        <br/>-----<br/>REST content projection, version IDs, export</small>"]
        aisvc["<<component>><br/><b>AI Service</b><br/><small>backend/ai/service.py<br/>-----
        <br/>Feature dispatch, streaming and full completions</small>"]
        prompt["<<component>><br/><b>Prompt Engine</b><br/><small>backend/ai/prompts.py
        <br/>-----<br/>Templates for rewrite, summarize, translate,
        restructure, continue</small>"]
        groqclient["<<component>><br/><b>Groq API Client</b><br/><small>
        backend/ai/groq_client.py<br/>-----<br/>Async HTTP, streaming,
        timeout handling</small>"]
    end

    spa -->|"HTTPS REST + SSE"| app
    app --> schemas
    app --> auth
    app --> runtime
    app --> store
    ...
    style groq fill:#999,color:#fff,stroke:#fff
    style db fill:#1168bd,color:#fff,stroke:#fff
    style app fill:#2a5fa5,color:#fff,stroke:#fff
    style schemas fill:#2a5fa5,color:#fff,stroke:#fff
    style auth fill:#2a5fa5,color:#fff,stroke:#fff
    style runtime fill:#2a5fa5,color:#fff,stroke:#fff
    style store fill:#2a5fa5,color:#fff,stroke:#fff
...
\href{https://mermaid.ai/d/5e645a47-b3c3-49fd-9456-8c8ab2c415ca}{Entity-relationship diagram}
\begin{verbatim}
erDiagram
...
The repository can be run locally from the provided README, and the editable Mermaid sources for all required diagrams live under \texttt{docs/master\_contract/diagrams/}. A separate demo recording accompanies the submission package; it is not stored in the repository itself.
