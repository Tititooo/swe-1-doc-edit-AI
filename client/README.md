...
**Files:**
- [client/src/components/LoadDocumentButton.tsx](client/src/components/LoadDocumentButton.tsx)
- [client/src/hooks/useDocument.ts](client/src/hooks/useDocument.ts)
...
**Files:**
- [client/src/components/TextAreaEditor.tsx](client/src/components/TextAreaEditor.tsx)
...
**Files:**
- [client/src/components/AISidebar.tsx](client/src/components/AISidebar.tsx)
- [client/src/hooks/useAI.ts](client/src/hooks/useAI.ts)
- [client/src/api/documentAPI.ts](client/src/api/documentAPI.ts)
...
**Files:**
- [client/src/components/ConflictWarningBanner.tsx](client/src/components/ConflictWarningBanner.tsx)
- [client/src/hooks/useVersionConflict.ts](client/src/hooks/useVersionConflict.ts)
...
**Files:**
- [client/src/components/ErrorBanner.tsx](client/src/components/ErrorBanner.tsx)
